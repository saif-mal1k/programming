...
///arr+i->ith 1D array
///*arr+i->1st element of ith 1D array
///(*(arr+i)+j)jth element of ith 1D array
///hence,*(*(arr+i)+j) prints jth element of ith 1D array
///*(*(arr+i)+j) = arr[i][j] ///by subscript notation
