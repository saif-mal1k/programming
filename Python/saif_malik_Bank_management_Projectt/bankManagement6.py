...
class customer(object):
    def __init__(self):
        ...
        self.dob = input("Enter your dob (yyyy-mm-dd): ") #dt.date(int(y), int(m), int(d))
    ...
    def updateDetails(data):
        while True:
            ...
            if ch == 1:
                ...
                #y, m, d = input("Enter your dob (yyyy-mm-dd): ").split("-")
                (dictionary_of_customers[Account_no])['dob'] = input("Enter your dob (yyyy-mm-dd): ") # dt.date(int(y), int(m), int(d))
