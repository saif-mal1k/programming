...
class customer(object):
    ...
    def existing_customer(Account_no):
        ...
        while True:
            ...
            if ch == 1:
                ...
                print(
                    "*********************************************************************************************************")
                print("your account: ", dictionary_of_customers.pop(
                    Account_no), "is deleted")
                break
                #self.deleteAccount()
    ...
    def withdrawl(Account_no):
        ...
        withdrawl_ammount = int(
            input("enter the amount you want to \"withdraw\": ".title()))
        (dictionary_of_customers[Account_no])[
            'Balance '] -= withdrawl_ammount      # for updated customer details
    ...
    def deposit(Account_no):
        ...
        deposited_ammount = int(
            input("enter the amount you want to \"Deposit\": ".title()))
        (dictionary_of_customers[Account_no])[
            'Balance '] += deposited_ammount      # for updated customer details
        # fetching new balance
        customerDetails = dictionary_of_customers[Account_no]
        Balance = customerDetails['Balance ']
        print("UPDATED Balance \t: ", Balance)
